...
import lombok.Data;
import stamll.OrderApplication;
import stamll.domain.OrderCancelled;
import stamll.domain.OrderPlaced;
...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateState(DeliveryCompleted deliveryCompleted) {
        //implement business logic here:
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateState(ShippingReturned shippingReturned) {
        //implement business logic here:
